...
def initialize_vo(img1: np.ndarray, img2: np.ndarray, 
                  K: np.ndarray,
...
def estimate_pose_2d_to_2d(kpts1: np.ndarray, kpts2: np.ndarray,
...
def triangulate_points(kpts1: np.ndarray, kpts2: np.ndarray,
...
def create_initial_landmark_database(landmarks_3d: np.ndarray,
                                     descriptors: np.ndarray) -> LandmarkDatabase:
    """
