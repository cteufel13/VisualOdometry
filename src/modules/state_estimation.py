...
def estimate_pose_pnp(points_3d: np.ndarray,
                      points_2d: np.ndarray,
                      K: np.ndarray,
                      initial_R: np.ndarray | None = None,
                      initial_t: np.ndarray | None = None) -> tuple[np.ndarray, np.ndarray, np.ndarray, float]:
    """
...
def pnp_ransac(points_3d: np.ndarray,
               points_2d: np.ndarray,
               K: np.ndarray,
               num_iterations: int = 1000,
               reprojection_threshold: float = 3.0) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
...
def refine_pose_nonlinear(points_3d: np.ndarray,
                         points_2d: np.ndarray,
                         R_init: np.ndarray,
                         t_init: np.ndarray,
